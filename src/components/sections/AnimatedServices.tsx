    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-[#111111] flex flex-col items-center justify-center p-4 border border-[#d62020]"
...
export function AnimatedServices() {
    ...
    // Map native scroll to the virtual scroll range (0 to 3000)
            ...
            <div ref={containerRef} className="sticky top-0 w-full h-screen overflow-hidden py-[100px] select-none">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="text-[48px] md:text-[64px] font-[800] font-heading leading-[1] tracking-[-0.03em] text-[#111111]"
                    >
                        Services that <span className="text-[#d62020]">drive growth.</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={introPhase === "circle" && morphValue < 0.5 ? { opacity: 0.5 - morphValue } : { opacity: 0 }}
                        transition={{ duration: 1, delay: 0.2 }}
                        className="mt-4 text-[12px] font-bold tracking-[0.2em] text-[#666666] uppercase"
                    >
                        SCROLL TO EXPLORE
                    </motion.p>
                </div>
                ...
                <motion.div
                    ...
                    className="absolute top-[100px] z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4 w-full"
                >
                    <p className="text-[48px] lg:text-[64px] font-[800] font-heading leading-[1] tracking-[-0.03em] text-[#111111] mb-[24px]">
                        Choose Your Growth Solution
                    </p>
                    <p className="text-[18px] lg:text-[20px] font-sans text-[#666666] max-w-[650px] mx-auto leading-relaxed">
