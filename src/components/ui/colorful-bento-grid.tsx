...
export const ColorfulBentoGrid = () => {
  return (
    <section id="free-tools" className="bg-white rounded-[32px] p-8 md:p-12 max-w-6xl mx-auto py-16 md:py-24">
      <div className="flex flex-col md:flex-row items-end justify-between w-full">
        <div className="flex flex-col my-6 w-full items-start justify-start gap-4">
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-end w-full justify-between">
            <h2 className="relative text-4xl md:text-5xl font-heading font-black tracking-tight max-w-xl text-left leading-[1.1] text-[#0A0A0A] mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        >
          <div className="relative flex flex-col items-start justify-center gap-1">
            <p className="-rotate-1 text-sm font-medium text-[#0A0A0A] mb-6">1,000 downloads</p>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-1 mt-4">
            <p className="rotate-6 text-sm font-medium text-[#0A0A0A] mb-6">10,000 uses</p>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-1 mt-4">
            <p className="-rotate-3 text-sm font-medium text-[#0A0A0A] mb-6">106 Behavioral Principles</p>
        ...
        >
          <p className="-rotate-3 text-sm font-medium text-[#0A0A0A] mb-6">Blog &amp; Guides</p>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-1">
            <p className="rotate-6 text-sm font-medium text-[#0A0A0A] mb-6">Playbooks</p>
