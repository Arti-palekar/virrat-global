    ...
    <section className="w-full bg-[#FAF9F6] py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-black tracking-tighter leading-none uppercase text-[#111111]">
            Our Digital Ecosystem
          </h2>
        </div>

        {/* Clip-Path Links Grid */}
        <div className="divide-y border divide-zinc-200 border-zinc-200 rounded-[20px] overflow-hidden bg-white shadow-sm">
          <div className="grid grid-cols-2 divide-x divide-zinc-200">
            <LinkBox Icon={SiGoogle} href="https://mail.google.com/mail/u/0/?fs=1&to=kamalkamalesh316@gmail.com&tf=cm" />
            <LinkBox Icon={FaGithub} href="https://github.com/kamaleshsa" />
          </div>
          <div className="grid grid-cols-4 divide-x divide-zinc-200">
            <LinkBox Icon={FaTwitter} href="https://x.com/Kamales71036733" />
            <LinkBox Icon={FaLinkedin} href="https://www.linkedin.com/in/kamaleshsa" />
            <LinkBox Icon={FaInstagram} href="https://www.instagram.com/k.a.m.a_l?igsh=ZmRzbXF6NTBwOXIw" />
            <LinkBox Icon={FaFacebook} href="https://www.facebook.com/share/16Zgo4MK6M/" />
          </div>
...
const LinkBox = ({ Icon, href, imgSrc, className }: LinkBoxProps) => {
  ...
  return (
    <a
      ...
      className="relative grid h-20 w-full place-content-center sm:h-28 md:h-36 text-zinc-800 bg-white hover:text-[#d62020] transition-colors duration-300"
    >
      {imgSrc ? (
        <img
          src={imgSrc}
          alt="custom icon"
          className={className ?? "max-h-10 sm:max-h-16 md:max-h-20 object-contain filter grayscale"}
          draggable={false}
        />
      ) : (
      ...
      <div
        ...
        className="absolute inset-0 grid place-content-center bg-[#d62020] text-white transition-colors duration-300"
      >
        {imgSrc ? (
          <img
            src={imgSrc}
