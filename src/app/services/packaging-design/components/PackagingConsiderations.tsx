...
export default function PackagingConsiderations() {
  ...
  const cardsData = [
    {
      ...
      desc: "Logo, colors, typography and visual elements aligned with your brand identity.",
      icon: Palette
    },
    {
      type: "image",
    ...
    },
    {
      ...
      title: "Shelf Appeal",
      metric: "92%",
      metricLabel: "SHELF IMPACT",
      desc: "Strong visual hierarchy and distinctive design that helps products stand out.",
      icon: Sparkles
    },
    {
      type: "image",
    ...
    },
    {
      ...
      desc: "Production-ready artwork with correct dimensions, bleed, color profiles and dielines.",
      icon: Printer
    },
    {
      type: "image",
    ...
    },
    {
      ...
      desc: "Packaging designed around usability, unboxing and the overall customer experience.",
      icon: Users
    },
    {
      type: "image",
