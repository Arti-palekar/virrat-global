...
export default function AiAutomationIndustries() {
  return (
    <section className="w-full bg-[#050b09] px-6 md:px-12 lg:px-24 border-b border-zinc-900 relative overflow-hidden flex flex-col justify-between min-h-[750px] lg:min-h-[850px] py-16 md:py-24">
      ...
      <div className="max-w-5xl mx-auto z-10 relative text-center w-full mb-12">
        {/* Small Label */}
