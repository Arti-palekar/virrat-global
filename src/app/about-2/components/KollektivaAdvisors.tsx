...
const team = [
  {
    ...
    color: "#a259ff",
    position: "left-[-8px] top-[55%] flex-row-reverse items-center gap-1",
    isDog: false
  },
  {
  ...
  },
  {
    ...
    color: "#ff7262",
    position: "right-4 top-[35%] flex-row items-center gap-1",
    isDog: false
  },
  {
    name: "Kevin Davis",
    ...
    color: "#27ae60",
    position: "right-4 top-[50%] flex-row items-center gap-1",
    isDog: false
  },
  {
    name: "Samba",
    ...
    color: "#18a0fb",
    position: "right-4 top-4 flex flex-col items-center gap-1",
    isDog: true
  },
  {
    name: "Jamie Sergeant",
    ...
    color: "#a259ff",
    position: "left-[-8px] top-[60%] flex-row-reverse items-center gap-1",
    isDog: false
  },
  {
    name: "Krishna Panikar",
    role: "Global Finance Manager",
    firstName: "Krishna",
...
export default function KollektivaAdvisors() {
  return (
    <section className="w-full bg-[#fcfbf7] py-16 md:py-24 px-6 sm:px-10 lg:px-16 text-[#111111] font-sans select-none overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10 md:gap-x-8 md:gap-y-12">
        {team.map((member, idx) => (
          <div key={`advisor-card-${idx}`} className="flex flex-col">
            ...
            <div className="group relative aspect-[3/4] rounded-2xl overflow-hidden bg-slate-100 shadow-sm border border-[#111111]/5 cursor-pointer">
