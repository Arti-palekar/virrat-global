    ...
    card: {
      ...
      tasks: [
        ...
        },
        {
          ...
          meta: "Completed in 9.3s",
          status: "completed",
        },
        {
          title: "Performance audit",
          meta: "In progress... 22s",
          status: "progress",
        },
        {
          title: "Security scan",
        ...
        <div className="grid md:grid-cols-2 gap-14 items-start mb-10">
          ...
          <div>
            <p className="text-[18px] leading-[32px] text-[#666] max-w-lg">
              ...
              product — from design systems to production
              deployment, built by{" "}
