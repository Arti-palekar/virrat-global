...
export function WebSoftwareTestimonials() {
  return (
    <section className="w-full bg-[#0F0F10] text-white py-24 md:py-32 relative overflow-hidden border-b border-white/10">
      <div className="container mx-auto px-6 max-w-[1400px]">
        {/* Header matching exact layout position */}
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12 max-w-[1060px] mx-auto">
          <div className="max-w-md">
            <span className="text-xs font-mono font-bold tracking-[0.2em] text-[#D62020] uppercase block mb-2">
              CLIENT TESTIMONIALS
            </span>
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white font-heading leading-[1.08]">
              Trusted by teams <br />
              who move <span className="text-[#D62020]">fast</span>
            </h2>
          </div>

          <p className="text-[14px] md:text-[15px] text-[#A0A0A0] max-w-xs font-body leading-relaxed md:text-right">
            Real feedback from real tech leaders and enterprise partners who rely on Virrat Global for software product delivery.
          </p>
        </div>

        {/* Scroll Reel Component */}
...
export default WebSoftwareTestimonials;
